...
Partial Class FacturaVentas
    ...
    Private Sub InitializeComponent()
        ...
        Me.SelectVentaBindingSource = New System.Windows.Forms.BindingSource(Me.components)
        Me.SelectVentaTableAdapter = New BazarRoxanaTableAdapters.SelectVentaTableAdapter()
        ...
        CType(Me.SelectVentaBindingSource, System.ComponentModel.ISupportInitialize).BeginInit()
        Me.SuspendLayout()
        '
        'ReportViewer1
        '
        ...
        ReportDataSource1.Value = Me.SelectDetalleVentaBindingSource
        ReportDataSource2.Name = "Venta"
        ReportDataSource2.Value = Me.SelectVentaBindingSource
        ...
        '
        'SelectVentaBindingSource
        '
        Me.SelectVentaBindingSource.DataMember = "SelectVenta"
        Me.SelectVentaBindingSource.DataSource = Me.BazarRoxana
        '
        'SelectVentaTableAdapter
        '
        Me.SelectVentaTableAdapter.ClearBeforeFill = True
        '
        'FacturaVentas
        '
        ...
        CType(Me.SelectVentaBindingSource, System.ComponentModel.ISupportInitialize).EndInit()
    ...
    Friend WithEvents SelectVentaBindingSource As BindingSource
    Friend WithEvents SelectDetalleVentaTableAdapter As BazarRoxanaTableAdapters.SelectDetalleVentaTableAdapter
    Friend WithEvents SelectVentaTableAdapter As BazarRoxanaTableAdapters.SelectVentaTableAdapter
End Class
